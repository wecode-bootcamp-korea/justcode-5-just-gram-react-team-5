            ...
            <div className={styles.header}>
                ...
                <div className={styles.header_box}>
                    ...
                    <div className={styles.search_box}>
                        <img className={styles.magnifying_glass} src="images/sohee/search.png" alt="magnifying_glass" />
            ...
            <div className={styles.contents}>
                ...
                <div className={styles.floationg_section}>
                            ...
                            <div className={styles.recommend_group}>
                                ...
                                <div className={styles.recommend_b_box}>
                                    ...
                                    <div className={styles.recommend_b_text}>
                                        ...
                                        <div className={styles.grey}>ringo.in.seoul님 외 12...</div>
                                    </div>
                                    <button>팔로우</button>
                                </div>
                    ...
                    <div className={styles.company_info_box}>
                        <div className={styles.info}><span>Justgram 정보</span> ・ <span>지원</span> ・ 
